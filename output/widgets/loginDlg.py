...
class Ui_Dialog(object):
 ...
 #       Dialog.setModal(False)
        ...
        self.gridLayout.addWidget(self.label_err, 1, 1, 1, 1)
        self.passwd2 = QtWidgets.QLineEdit(Dialog)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.passwd2.setFont(font)
        ...
        Dialog.setTabOrder(self.login, self.passwd)
        Dialog.setTabOrder(self.passwd, self.buttonBox)
